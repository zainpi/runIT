import { apiJson, checkBodySize, enforceRateLimit, getAdminClient, getMembership, handleApiError, requireSession } from "@/lib/pulsedeals/server";
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    const result = await admin.rpc("claim_pulsedeals_marketplace", { p_account_id: session.sub, p_marketplace: body.marketplace });
