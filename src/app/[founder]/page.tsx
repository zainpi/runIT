  ...
  return (
    <div className={os.root} data-os>
      ...
      <main id="main" className={`${os.container} ${styles.portfolio}`}>
          ...
          <Window as="section" title={`${founder.slug}.profile`} tone={founder.tone} labelledBy="founder-heading" className={styles.profileWindow}>
            <div className={styles.profileBody}>
              ...
              <div className={styles.profileText}>
                ...
                <a className={os.button} href="#work" id="hero-cta">Explore our work <ArrowIcon /></a>
                {founder.x && <a className={os.textLink} href={xProfileUrl(founder.x)} rel="me noopener">@{founder.x} on X</a>}
              </div>
            </div>
          </Window>
        ...
        <Window as="section" id="contact" title="hello.txt" tone="#fffdf7" labelledBy="portfolio-contact-heading" className={styles.contactWindow}>
          <div className={styles.windowBody}>
