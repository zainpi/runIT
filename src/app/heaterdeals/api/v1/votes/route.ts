...
import { HEATER_DEAL_VOTES, type HeaterDealVote } from "@/lib/heaterdeals/types";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    const vote = typeof body.vote === "string" && (HEATER_DEAL_VOTES as readonly string[]).includes(body.vote)
      ? body.vote as HeaterDealVote
      : null;
