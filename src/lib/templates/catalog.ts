export const templateCatalog = [
  ...
  { id: "roblox-game", title: "Roblox game", category: "Create & play", symbol: "blocks", description: "Give players a world to make their own, with building tools, progression, and reliable saves.", includes: ["Building & placement", "Inventory & progression", "Multiplayer & safe saves", "Optional Robux purchases"], stack: "Luau · Roblox Studio · DataStore", color: "blue" },
  { id: "mobile-game", title: "Mobile game", category: "A world in your pocket", symbol: "game", description: "Build a game players can return to. A complete foundation for combat, progression, and live features.", includes: ["Game loop & content systems", "Optional accounts & cloud saves", "Optional purchases & ads", "iOS & Android release"], stack: "Godot · GDScript · Supabase", color: "peach" },
  { id: "mobile-app", title: "Mobile app", category: "Everyday utility", symbol: "phone", description: "Bring a useful idea to life with accounts, feeds, saved items, notifications, and optional AI features.", includes: ["Native screens & offline state", "Accounts & subscriptions", "Feeds, imports & AI modules", "Backend & App Store setup"], stack: "SwiftUI · Cloudflare · Supabase", color: "mint" },
  ...
  { id: "browser-game", title: "Browser game", category: "Just open & play", symbol: "globe", description: "Build a location-based guessing game with maps, daily challenges, scoring, and saved progress.", includes: ["Game rounds & daily challenges", "Maps & street imagery", "Server-verified scoring", "Usage limits & deployment"], stack: "JavaScript · Cloudflare · Maps", color: "lime" },
] as const;
